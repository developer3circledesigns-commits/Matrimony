...
if (($segments[0] ?? null) === 'api') {
    ...
    $apiFile = BASE_PATH . '/api/' . implode('/', $apiSegments) . '.php';
...
if (($segments[0] ?? null) === 'favicon.ico') {
    $favicon = BASE_PATH . '/public_html/assets/fav_icon_img.png';
    if (is_file($favicon)) {
...
$moduleFile = BASE_PATH . '/modules/' . $module . '/index.php';

if (!is_file($moduleFile)) {
    http_response_code(404);
    require BASE_PATH . '/modules/home/index.php';
    return;
}
